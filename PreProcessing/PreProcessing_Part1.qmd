...
We use a validation dataset with 20% of the observations in `penguins_data`. The other 80% will be in the training dataset.
...
Using `SimpleImputer()`, we set the method to imput missing values using the **mean**. 
