...
Python, like all programming languages, is very demanding. For example, if you write
...
# This code will assign the number 18 to the object called my_favorite_number
...
We can do simple operations with vectors. For example, we can multiply sum all the elements of a list.
...
We can select specific variables of a dataset using the syntaxis below.
